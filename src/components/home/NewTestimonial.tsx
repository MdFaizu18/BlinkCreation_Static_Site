...
export default function NewTestimonial() {
  ...
  return (
    <section className="relative py-20 px-4 overflow-hidden bg-gradient-to-b from-[black] to-[black]">
          ...
          {testimonials.map((testimonial, index) => (
            <div
              ...
              className={`group relative p-8 rounded-2xl transition-all duration-500 hover:scale-105
                ${index === activeIndex ? "bg-white shadow-2xl" : "bg-white hover:bg-white hover:shadow-xl"}`}
